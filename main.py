...
def attack(char_name: str, char_class: str) -> str:
    """Функция описывает механику атаки."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция описывает механику защиты."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция описывает механику применения специальной способности."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция описывает механику тренировки."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция описывает механику выбора персонажа."""
    approve_choice: str = ''
    char_class: str = ''
...
if __name__ == '__main__':
    """Основная функция, запускаюзая код."""
